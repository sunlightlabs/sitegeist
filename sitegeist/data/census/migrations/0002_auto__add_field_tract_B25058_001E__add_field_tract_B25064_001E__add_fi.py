...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tract.B25058_001E'
        db.add_column('census_tract', 'B25058_001E',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Tract.B25064_001E'
        db.add_column('census_tract', 'B25064_001E',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Tract.B25077_001E'
        db.add_column('census_tract', 'B25077_001E',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Tract.B25003_001E'
        db.add_column('census_tract', 'B25003_001E',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Tract.B25003_002E'
        db.add_column('census_tract', 'B25003_002E',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Tract.B25003_003E'
        db.add_column('census_tract', 'B25003_003E',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tract.B25058_001E'
        db.delete_column('census_tract', 'B25058_001E')

        # Deleting field 'Tract.B25064_001E'
        db.delete_column('census_tract', 'B25064_001E')

        # Deleting field 'Tract.B25077_001E'
        db.delete_column('census_tract', 'B25077_001E')

        # Deleting field 'Tract.B25003_001E'
        db.delete_column('census_tract', 'B25003_001E')

        # Deleting field 'Tract.B25003_002E'
        db.delete_column('census_tract', 'B25003_002E')

        # Deleting field 'Tract.B25003_003E'
        db.delete_column('census_tract', 'B25003_003E')
